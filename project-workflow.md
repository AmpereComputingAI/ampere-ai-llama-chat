...
Ollama_Server->>+Llama_Cpp_Server: Sends API request to http://127.0.0.1:port/health
Llama_Cpp_Server-->>-Ollama_Server: 
Ollama_Server->>+Llama_Cpp_Server: Sends API request to http://127.0.0.1:port/completion
Llama_Cpp_Server-->>-Ollama_Server: 
